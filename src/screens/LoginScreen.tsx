      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <LinearGradient colors={['#007AFF', '#0056CC']} style={styles.header}>
          <View style={styles.logoContainer}>
            ...
            <Text style={styles.appName}>Thryft Club</Text>
            <Text style={styles.tagline}>Thrift & Sustainable Marketplace</Text>
          </View>
        </LinearGradient>

        {/* Wallet Connect Form */}
        <View style={styles.formContainer}>
          <Text style={styles.welcomeText}>Welcome to Thryft Club!</Text>
          <Text style={styles.subtitleText}>
            Connect your wallet to start your sustainable journey
          </Text>
          ...
          <View style={styles.walletInfo}>
            ...
            <View style={styles.walletInfoItem}>
              ...
              />
              <Text style={styles.walletInfoText}>
                Verify products and earn rewards
              </Text>
            </View>
          </View>
